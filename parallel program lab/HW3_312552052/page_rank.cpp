...
void pageRank(Graph g, double *solution, double damping, double convergence)
{
  ...
  double thread_noOutgoing_sum[numOfthread][12]; // padding 64 byte to aviod false sharing (Assuming cache line is 64 bytes)
  double thread_global_diff[numOfthread][12];
